...
`1`: Yes (no consent required)
    ...
    deserialize(params) {
        ...
        this.InteractionMode = 'InteractionMode' in params ? params.InteractionMode : null;
        this.VideoOrientation = 'VideoOrientation' in params ? params.VideoOrientation : null;
        this.IsGradingRequiredPostClass = 'IsGradingRequiredPostClass' in params ? params.IsGradingRequiredPostClass : null;
        this.RoomType = 'RoomType' in params ? params.RoomType : null;
        this.EndDelayTime = 'EndDelayTime' in params ? params.EndDelayTime : null;
        this.LiveType = 'LiveType' in params ? params.LiveType : null;
        this.RecordLiveUrl = 'RecordLiveUrl' in params ? params.RecordLiveUrl : null;
        this.EnableAutoStart = 'EnableAutoStart' in params ? params.EnableAutoStart : null;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    deserialize(params) {
        ...
        this.CurrentState = 'CurrentState' in params ? params.CurrentState : null;
...
class DescribeRoomRequest extends  AbstractModel {
    ...
    deserialize(params) {
        ...
        this.RoomId = 'RoomId' in params ? params.RoomId : null;
        this.RTMPStreamingURL = 'RTMPStreamingURL' in params ? params.RTMPStreamingURL : null;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    deserialize(params) {
        ...
        if (params.CustomMessage) {
            let obj = new CustomMsgContent();
            obj.deserialize(params.CustomMessage)
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    deserialize(params) {
        ...
        this.RecordSize = 'RecordSize' in params ? params.RecordSize : null;
        this.RecordUrl = 'RecordUrl' in params ? params.RecordUrl : null;
...
class ModifyAppRequest extends  AbstractModel {
    ...
    deserialize(params) {
        ...
        this.TransferId = 'TransferId' in params ? params.TransferId : null;
        this.TransferUrl = 'TransferUrl' in params ? params.TransferUrl : null;
