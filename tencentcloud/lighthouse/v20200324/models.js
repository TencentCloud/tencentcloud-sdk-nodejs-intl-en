...
/**
 * CancelShareBlueprintAcrossAccounts response structure.
 * @class
 */
class CancelShareBlueprintAcrossAccountsResponse extends  AbstractModel {
    constructor(){
        super();
...
class SyncBlueprintResponse extends  AbstractModel {
    constructor(){
        ...
        /**
         * Image information of the target region.
         * @type {Array.<DestinationRegionBlueprint> || null}
         */
        this.DestinationRegionBlueprintSet = null;
    ...
    deserialize(params) {
        ...
        if (params.DestinationRegionBlueprintSet) {
            this.DestinationRegionBlueprintSet = new Array();
            for (let z in params.DestinationRegionBlueprintSet) {
                let obj = new DestinationRegionBlueprint();
                obj.deserialize(params.DestinationRegionBlueprintSet[z]);
                this.DestinationRegionBlueprintSet.push(obj);
            }
        }
        this.RequestId = 'RequestId' in params ? params.RequestId : null;
...
"CAREFREE": carefree package
    ...
    deserialize(params) {
        ...
        this.TrafficUnlimited = 'TrafficUnlimited' in params ? params.TrafficUnlimited : null;
...
module.exports = {
    ...
    CancelShareBlueprintAcrossAccountsRequest: CancelShareBlueprintAcrossAccountsRequest,
