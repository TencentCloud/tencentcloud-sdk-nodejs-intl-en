...
class PortraitImageInfo extends  AbstractModel {
    ...
    deserialize(params) {
        ...
        if (params.ImageCoordinates) {
            let obj = new ImageCoordinates();
            obj.deserialize(params.ImageCoordinates)
            this.ImageCoordinates = obj;
        }
...
class HmtResidentPermitOCRResponse extends  AbstractModel {
    constructor(){
         ...
         * @type {PortraitImageInfo || null}
         */
        this.PortraitImageInfo = null;
...
-9109 This capability is not enabled. Please contact customer support to activate the alert service
    ...
    deserialize(params) {
        ...
        if (params.PortraitImageInfo) {
            let obj = new PortraitImageInfo();
            obj.deserialize(params.PortraitImageInfo)
            this.PortraitImageInfo = obj;
        }
        this.WarnCardInfos = 'WarnCardInfos' in params ? params.WarnCardInfos : null;
        this.RequestId = 'RequestId' in params ? params.RequestId : null;
