 ...
 * @class
 */
class ApproveSubAgentApplyResponse extends  AbstractModel {
    constructor(){
        super();
 ...
 * @class
 */
class DescribeRebateDownloadUrlResponse extends  AbstractModel {
    constructor(){
        super();
 ...
 * @class
 */
class DescribeCustomerBillDetailByDayResponse extends  AbstractModel {
    constructor(){
        super();
 ...
 * @class
 */
class QueryPendingSubAgentsV2Response extends  AbstractModel {
    constructor(){
        super();

        /**
         * Application in progress second-level reseller information.
         * @type {Array.<QueryPendingSubAgentsV2ResponseData> || null}
         */
        this.Data = null;
    ...
    deserialize(params) {
        ...
        if (params.Data) {
            this.Data = new Array();
            for (let z in params.Data) {
                let obj = new QueryPendingSubAgentsV2ResponseData();
                obj.deserialize(params.Data[z]);
                this.Data.push(obj);
            }
        }
...
Note: this field takes effect only in the scenario of inviting a second-level reseller.
    ...
    deserialize(params) {
        ...
        this.Email = 'Email' in params ? params.Email : null;
        this.InvitationRole = 'InvitationRole' in params ? params.InvitationRole : null;
        this.MaterialUrl = 'MaterialUrl' in params ? params.MaterialUrl : null;
