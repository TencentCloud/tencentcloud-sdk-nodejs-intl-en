...
const CreateAiDramaTaskRequest = models.CreateAiDramaTaskRequest;
...
const CloneViralRequest = models.CloneViralRequest;
...
const AiRestorationConfig = models.AiRestorationConfig;
...
const CreateAiFissionTaskResponse = models.CreateAiFissionTaskResponse;
...
const DescribeTextToSpeechAsyncTaskRequest = models.DescribeTextToSpeechAsyncTaskRequest;
const AigcAudioOutputVideoInfo = models.AigcAudioOutputVideoInfo;
...
const ChangeVoiceResponse = models.ChangeVoiceResponse;
...
const DubbingConfig = models.DubbingConfig;
...
const CustomModel = models.CustomModel;
...
const ChangeVoiceRequest = models.ChangeVoiceRequest;
...
const CreateAiDramaTaskResponse = models.CreateAiDramaTaskResponse;
...
const AiDramaInput = models.AiDramaInput;
...
const OverrideAIDubbingParameter = models.OverrideAIDubbingParameter;
...
const DocToVideoWatermarkInfo = models.DocToVideoWatermarkInfo;
const TaskStatData = models.TaskStatData;
const SubtitleBoardConfig = models.SubtitleBoardConfig;
const DescribeAigcAudioTaskResponse = models.DescribeAigcAudioTaskResponse;
...
const DubbingTranslateConfig = models.DubbingTranslateConfig;
...
const DescribeAigcTaskListResponse = models.DescribeAigcTaskListResponse;
...
const CloneViralContent = models.CloneViralContent;
...
const UnderstandImageConfig = models.UnderstandImageConfig;
...
const AigcTaskListItem = models.AigcTaskListItem;
...
const CloneVoiceResponse = models.CloneVoiceResponse;
...
const AIDubbingTaskInput = models.AIDubbingTaskInput;
...
const ModifyDocToVideoTaskStatusResponse = models.ModifyDocToVideoTaskStatusResponse;
...
const LiveAiAnalysisDescriptionItem = models.LiveAiAnalysisDescriptionItem;
const PornOcrReviewTemplateInfoForUpdate = models.PornOcrReviewTemplateInfoForUpdate;
const DstSubtitleInput = models.DstSubtitleInput;
...
const AiFissionInput = models.AiFissionInput;
...
const ModifyProcessImageTemplateResponse = models.ModifyProcessImageTemplateResponse;
...
const EmbeddingDataRequest = models.EmbeddingDataRequest;
...
const QueryProjectResponse = models.QueryProjectResponse;
const DescribeAigcTaskStatusResponse = models.DescribeAigcTaskStatusResponse;
...
const QueryProjectRequest = models.QueryProjectRequest;
...
const DescribeTextToSpeechAsyncTaskResponse = models.DescribeTextToSpeechAsyncTaskResponse;
...
const CreateDocToVideoTaskRequest = models.CreateDocToVideoTaskRequest;
...
const DubbingOutputConfig = models.DubbingOutputConfig;
...
const AigcAudioExtraParam = models.AigcAudioExtraParam;
...
const CreateProcessImageTemplateRequest = models.CreateProcessImageTemplateRequest;
...
const DescribeAigcTaskStatusRequest = models.DescribeAigcTaskStatusRequest;
...
const DeleteSubtitleEmbedTemplateRequest = models.DeleteSubtitleEmbedTemplateRequest;
...
const VideoRedrawInput = models.VideoRedrawInput;
...
const ModifyDocToVideoTaskStatusInput = models.ModifyDocToVideoTaskStatusInput;
...
const DescribeSubtitleEmbedTemplatesResponse = models.DescribeSubtitleEmbedTemplatesResponse;
...
const DescribeCloneViralTaskResponse = models.DescribeCloneViralTaskResponse;
...
const DubbingEmbedSubtitleConfig = models.DubbingEmbedSubtitleConfig;
...
const DescribeAigcAudioTaskRequest = models.DescribeAigcAudioTaskRequest;
const ModifyAIRecognitionTemplateRequest = models.ModifyAIRecognitionTemplateRequest;
const DocToVideoInput = models.DocToVideoInput;
...
const VideoRedrawTaskInfo = models.VideoRedrawTaskInfo;
...
const CreateAiFissionTaskRequest = models.CreateAiFissionTaskRequest;
const CreateDocToVideoTaskResponse = models.CreateDocToVideoTaskResponse;
const ModifySmartSubtitleTemplateResponse = models.ModifySmartSubtitleTemplateResponse;
const CreateVideoRedrawTaskRequest = models.CreateVideoRedrawTaskRequest;
...
const AigcVideoReferenceSubjectInfo = models.AigcVideoReferenceSubjectInfo;
...
const SyncDubbingOutputOption = models.SyncDubbingOutputOption;
...
const DescribeImageTasksResponse = models.DescribeImageTasksResponse;
...
const ModifySubtitleEmbedTemplateRequest = models.ModifySubtitleEmbedTemplateRequest;
...
const CreateVideoRedrawTaskResponse = models.CreateVideoRedrawTaskResponse;
...
const QueryTaskFilter = models.QueryTaskFilter;
...
const AiStoryboardConfig = models.AiStoryboardConfig;
...
const DocToVideoBackgroundInfo = models.DocToVideoBackgroundInfo;
...
const DescribeCloneViralTaskRequest = models.DescribeCloneViralTaskRequest;
...
const DocToVideoCosInfo = models.DocToVideoCosInfo;
const AddOnSubtitle = models.AddOnSubtitle;
const AwsSQS = models.AwsSQS;
const DocToVideoRegenerateInput = models.DocToVideoRegenerateInput;
...
const CloneViralResponse = models.CloneViralResponse;
...
const SubtitleEmbedConfig = models.SubtitleEmbedConfig;
const TaskSimpleInfo = models.TaskSimpleInfo;
const EmbeddingResultItem = models.EmbeddingResultItem;
...
const ModifySubtitleEmbedTemplateResponse = models.ModifySubtitleEmbedTemplateResponse;
...
const RawAIDubbingParameter = models.RawAIDubbingParameter;
...
const CloneVoiceRequest = models.CloneVoiceRequest;
...
const CreateSubtitleEmbedTemplateRequest = models.CreateSubtitleEmbedTemplateRequest;
const EraseTimeArea = models.EraseTimeArea;
const TokensUsage = models.TokensUsage;
...
const ModifyDocToVideoTaskStatusRequest = models.ModifyDocToVideoTaskStatusRequest;
...
const DescribeAigcTaskListRequest = models.DescribeAigcTaskListRequest;
...
const VideoRedrawCosInfo = models.VideoRedrawCosInfo;
const EmbeddingDataResponse = models.EmbeddingDataResponse;
...
const DescribeImageTasksRequest = models.DescribeImageTasksRequest;
...
const CloneViralProduct = models.CloneViralProduct;
...
4) Video level: transition, playback speed adjustment, splicing, clipping, subtitles, picture-in-picture, audio-video separation, entrance and exit animations, and more.
     ...
     * @param {CreateAiFissionTaskRequest} req
     * @param {function(string, CreateAiFissionTaskResponse):void} cb
     * @public
     */
    CreateAiFissionTask(req, cb) {
        let resp = new CreateAiFissionTaskResponse();
        this.request("CreateAiFissionTask", req, resp, cb);
    }

    /**
     * This API is used to clone a voice type from a reference audio.
     * @param {CloneVoiceRequest} req
     * @param {function(string, CloneVoiceResponse):void} cb
     * @public
     */
    CloneVoice(req, cb) {
        let resp = new CloneVoiceResponse();
        this.request("CloneVoice", req, resp, cb);
    }
...
This API is not used to trigger network calls, but to help generate SDKs for each language platform. You can refer to the parsing implementation in the SDK to parse event notifications.
     ...
     * @param {CloneViralRequest} req
     * @param {function(string, CloneViralResponse):void} cb
     * @public
     */
    CloneViral(req, cb) {
        let resp = new CloneViralResponse();
        this.request("CloneViral", req, resp, cb);
    }
    ...
    /**
     * Model embedding API
     * @param {EmbeddingDataRequest} req
     * @param {function(string, EmbeddingDataResponse):void} cb
     * @public
     */
    EmbeddingData(req, cb) {
        let resp = new EmbeddingDataResponse();
        this.request("EmbeddingData", req, resp, cb);
    }
...
Note: templates with an ID below 10000 are preset and cannot be modified.
     ...
     * @param {ChangeVoiceRequest} req
     * @param {function(string, ChangeVoiceResponse):void} cb
     * @public
     */
    ChangeVoice(req, cb) {
        let resp = new ChangeVoiceResponse();
        this.request("ChangeVoice", req, resp, cb);
    }
     ...
     * @param {DeleteSubtitleEmbedTemplateRequest} req
     * @param {function(string, DeleteSubtitleEmbedTemplateResponse):void} cb
     * @public
     */
    DeleteSubtitleEmbedTemplate(req, cb) {
        let resp = new DeleteSubtitleEmbedTemplateResponse();
        this.request("DeleteSubtitleEmbedTemplate", req, resp, cb);
    }
...
* Only tasks in the last seven days (168 hours) can be queried.
     ...
     * @param {DescribeAigcTaskStatusRequest} req
     * @param {function(string, DescribeAigcTaskStatusResponse):void} cb
     * @public
     */
    DescribeAigcTaskStatus(req, cb) {
        let resp = new DescribeAigcTaskStatusResponse();
        this.request("DescribeAigcTaskStatus", req, resp, cb);
    }

    /**
     * Image processing task query API.
     * @param {DescribeImageTasksRequest} req
     * @param {function(string, DescribeImageTasksResponse):void} cb
     * @public
     */
    DescribeImageTasks(req, cb) {
        let resp = new DescribeImageTasksResponse();
        this.request("DescribeImageTasks", req, resp, cb);
    }
     ...
     * @param {DeleteProcessImageTemplateRequest} req
     * @param {function(string, DeleteProcessImageTemplateResponse):void} cb
     * @public
     */
    DeleteProcessImageTemplate(req, cb) {
        let resp = new DeleteProcessImageTemplateResponse();
        this.request("DeleteProcessImageTemplate", req, resp, cb);
    }

    /**
     * This API is used to modify an image processing template.
     * @param {ModifyProcessImageTemplateRequest} req
     * @param {function(string, ModifyProcessImageTemplateResponse):void} cb
     * @public
     */
    ModifyProcessImageTemplate(req, cb) {
        let resp = new ModifyProcessImageTemplateResponse();
        this.request("ModifyProcessImageTemplate", req, resp, cb);
    }
...
Contains two actions: confirm and regenerate.
     * @param {ModifyDocToVideoTaskStatusRequest} req
     * @param {function(string, ModifyDocToVideoTaskStatusResponse):void} cb
     * @public
     */
    ModifyDocToVideoTaskStatus(req, cb) {
        let resp = new ModifyDocToVideoTaskStatusResponse();
        this.request("ModifyDocToVideoTaskStatus", req, resp, cb);
    }
     ...
     * @param {CreateSubtitleEmbedTemplateRequest} req
     * @param {function(string, CreateSubtitleEmbedTemplateResponse):void} cb
     * @public
     */
    CreateSubtitleEmbedTemplate(req, cb) {
        let resp = new CreateSubtitleEmbedTemplateResponse();
        this.request("CreateSubtitleEmbedTemplate", req, resp, cb);
    }
...
5. Beauty filter;
     ...
     * @param {CreateVideoRedrawTaskRequest} req
     * @param {function(string, CreateVideoRedrawTaskResponse):void} cb
     * @public
     */
    CreateVideoRedrawTask(req, cb) {
        let resp = new CreateVideoRedrawTaskResponse();
        this.request("CreateVideoRedrawTask", req, resp, cb);
    }
     ...
     * @param {ModifySubtitleEmbedTemplateRequest} req
     * @param {function(string, ModifySubtitleEmbedTemplateResponse):void} cb
     * @public
     */
    ModifySubtitleEmbedTemplate(req, cb) {
        let resp = new ModifySubtitleEmbedTemplateResponse();
        this.request("ModifySubtitleEmbedTemplate", req, resp, cb);
    }
     ...
     * @param {CreateAiDramaTaskRequest} req
     * @param {function(string, CreateAiDramaTaskResponse):void} cb
     * @public
     */
    CreateAiDramaTask(req, cb) {
        let resp = new CreateAiDramaTaskResponse();
        this.request("CreateAiDramaTask", req, resp, cb);
    }
     ...
     * @param {QueryProjectRequest} req
     * @param {function(string, QueryProjectResponse):void} cb
     * @public
     */
    QueryProject(req, cb) {
        let resp = new QueryProjectResponse();
        this.request("QueryProject", req, resp, cb);
    }
...
Note: A workflow is disabled upon creation. You need to manually enable it.
     ...
     * @param {CreateProcessImageTemplateRequest} req
     * @param {function(string, CreateProcessImageTemplateResponse):void} cb
     * @public
     */
    CreateProcessImageTemplate(req, cb) {
        let resp = new CreateProcessImageTemplateResponse();
        this.request("CreateProcessImageTemplate", req, resp, cb);
    }
...
1. MPS statistical data from the last 365 days can be queried.
   2. The query time span should not exceed 90 days.
     ...
     * @param {DescribeCloneViralTaskRequest} req
     * @param {function(string, DescribeCloneViralTaskResponse):void} cb
     * @public
     */
    DescribeCloneViralTask(req, cb) {
        let resp = new DescribeCloneViralTaskResponse();
        this.request("DescribeCloneViralTask", req, resp, cb);
    }
...
This API is not used to trigger network calls, but to help generate SDKs for each language platform. You can refer to the parsing function in the SDK to implement event notification parsing.
     ...
     * @public
     */
    DescribeAigcAudioTask(req, cb) {
        let resp = new DescribeAigcAudioTaskResponse();
        this.request("DescribeAigcAudioTask", req, resp, cb);
    }

    /**
     * This API is used to query the result of an asynchronous text to speech task.
     * @param {DescribeTextToSpeechAsyncTaskRequest} req
     * @param {function(string, DescribeTextToSpeechAsyncTaskResponse):void} cb
     * @public
     */
...
This API is used to query tasks.
     ...
     * @public
     */
    CreateDocToVideoTask(req, cb) {
        let resp = new CreateDocToVideoTaskResponse();
        this.request("CreateDocToVideoTask", req, resp, cb);
    }
     ...
     * @param {DescribeSubtitleEmbedTemplatesRequest} req
     * @param {function(string, DescribeSubtitleEmbedTemplatesResponse):void} cb
     * @public
     */
    DescribeSubtitleEmbedTemplates(req, cb) {
        let resp = new DescribeSubtitleEmbedTemplatesResponse();
        this.request("DescribeSubtitleEmbedTemplates", req, resp, cb);
    }
...
Live stream processing event notification supports HTTP callbacks and also supports real-time writing to the message queue CMQ specified by the user. The user obtains the event notification result from the message queue CMQ. Meanwhile, if an output file exists during the process, it will be written to the target storage of the output file specified by the user.
     ...
     * @param {DescribeProcessImageTemplatesRequest} req
     * @param {function(string, DescribeProcessImageTemplatesResponse):void} cb
     * @public
     */
    DescribeProcessImageTemplates(req, cb) {
        let resp = new DescribeProcessImageTemplatesResponse();
        this.request("DescribeProcessImageTemplates", req, resp, cb);
    }
     ...
     * @param {DescribeAigcTaskListRequest} req
     * @param {function(string, DescribeAigcTaskListResponse):void} cb
     * @public
     */
    DescribeAigcTaskList(req, cb) {
        let resp = new DescribeAigcTaskListResponse();
        this.request("DescribeAigcTaskList", req, resp, cb);
    }
