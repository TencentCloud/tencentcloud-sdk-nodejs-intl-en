...
/**
 * GetPasswordRules request structure.
 * @class
 */
class GetPasswordRulesRequest extends  AbstractModel {
    constructor(){
        super();
...
/**
 * UpdatePasswordRules request structure.
 * @class
 */
class UpdatePasswordRulesRequest extends  AbstractModel {
    constructor(){
        super();

        /**
         * Password rules
         * @type {PassWordRule || null}
         */
        this.Rules = null;
...
/**
 * UpdatePasswordRules response structure.
 * @class
 */
class UpdatePasswordRulesResponse extends  AbstractModel {
    constructor(){
        super();
...
Note: This field may return null, indicating that no valid values can be obtained.
         * @type {number || null}
         */
        this.PasswordExpirationInvalidation = null;
    ...
    deserialize(params) {
        ...
        this.MinimumLength = 'MinimumLength' in params ? params.MinimumLength : null;
        this.MustContain = 'MustContain' in params ? params.MustContain : null;
        this.ForcePasswordChange = 'ForcePasswordChange' in params ? params.ForcePasswordChange : null;
        this.ReusePasswordLimit = 'ReusePasswordLimit' in params ? params.ReusePasswordLimit : null;
        this.RetryPasswordLimit = 'RetryPasswordLimit' in params ? params.RetryPasswordLimit : null;
        this.PasswordExpirationInvalidation = 'PasswordExpirationInvalidation' in params ? params.PasswordExpirationInvalidation : null;
