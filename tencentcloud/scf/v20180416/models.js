    ...
    deserialize(params) {
        ...
        if (params.Tolerations) {
            ...
            for (let z in params.Tolerations) {
                let obj = new K8SToleration();
                obj.deserialize(params.Tolerations[z]);
                this.Tolerations.push(obj);
            }
        }
        this.Port = 'Port' in params ? params.Port : null;
        this.PodTemplatePatch = 'PodTemplatePatch' in params ? params.PodTemplatePatch : null;
...
class K8SToleration extends  AbstractModel {
    ...
    deserialize(params) {
        ...
        this.Value = 'Value' in params ? params.Value : null;
        this.TolerationSeconds = 'TolerationSeconds' in params ? params.TolerationSeconds : null;
...
class CreateNamespaceRequest extends  AbstractModel {
    constructor(){
        ...
        /**
         * 
         * @type {NamespaceResourceEnv || null}
         */
        this.ResourceEnv = null;
    ...
    deserialize(params) {
        ...
        if (params.ResourceEnv) {
            let obj = new NamespaceResourceEnv();
            obj.deserialize(params.ResourceEnv)
            this.ResourceEnv = obj;
        }
...
class NamespaceResourceEnv extends  AbstractModel {
    constructor(){
        ...
        /**
         * 
         * @type {NamespaceResourceEnvTKE || null}
         */
        this.TKE = null;
    ...
    deserialize(params) {
        ...
        if (params.TKE) {
            let obj = new NamespaceResourceEnvTKE();
            obj.deserialize(params.TKE)
            this.TKE = obj;
        }
