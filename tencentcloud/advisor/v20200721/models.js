...
/**
 * CreateAdvisorAuthorization response structure.
 * @class
 */
class CreateAdvisorAuthorizationResponse extends  AbstractModel {
    constructor(){
        super();
...
/**
 * CreateAdvisorAuthorization request structure.
 * @class
 */
class CreateAdvisorAuthorizationRequest extends  AbstractModel {
    constructor(){
        super();
...
module.exports = {
    ...
    CreateAdvisorAuthorizationResponse: CreateAdvisorAuthorizationResponse,
