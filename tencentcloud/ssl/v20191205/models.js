 ...
 * @class
 */
class DescribeHostUploadUpdateRecordDetailResponse extends  AbstractModel {
    constructor(){
        super();
    ...
    deserialize(params) {
        ...
        if (params.DeployRecordDetail) {
            this.DeployRecordDetail = new Array();
            for (let z in params.DeployRecordDetail) {
                let obj = new DeployRecord();
                obj.deserialize(params.DeployRecordDetail[z]);
                this.DeployRecordDetail.push(obj);
            }
        }
        this.RequestId = 'RequestId' in params ? params.RequestId : null;
 ...
 * @class
 */
class UploadUpdateCertificateRecordRollbackRequest extends  AbstractModel {
    constructor(){
        super();
...
class DeployRecord extends  AbstractModel {
    constructor(){
         ...
         * @type {Array.<DeployRecordList> || null}
         */
 ...
 * @class
 */
class UploadUpdateCertificateRecordRetryResponse extends  AbstractModel {
    constructor(){
        super();
...
Note: This field may return null, indicating that no valid values can be obtained.
         * @type {Array.<DeployRecordItem> || null}
         */
        this.List = null;
 ...
 * @class
 */
class UploadUpdateCertificateRecordRollbackResponse extends  AbstractModel {
    constructor(){
        super();
