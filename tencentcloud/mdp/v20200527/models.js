 ...
 * @class
 */
class DescribeStreamPackageVodRemuxTaskRequest extends  AbstractModel {
    constructor(){
        super();
 ...
 * @class
 */
class StartStreamPackageVodRemuxTaskResponse extends  AbstractModel {
    constructor(){
        super();
 ...
 * @class
 */
class DescribeStreamPackageVodRemuxTaskResponse extends  AbstractModel {
    constructor(){
        super();

        /**
         * VOD remux task information.
         * @type {VodRemuxTaskInfo || null}
         */
        this.Info = null;
 ...
 * @class
 */
class DeleteStreamPackageVodRemuxTasksRequest extends  AbstractModel {
    constructor(){
        super();
 ...
 * @class
 */
class DeleteStreamPackageVodRemuxTasksResponse extends  AbstractModel {
    constructor(){
        super();
 ...
 * @class
 */
class DeleteStreamPackageVodRemuxTaskRequest extends  AbstractModel {
    constructor(){
        super();
 ...
 * @class
 */
class DescribeStreamPackageVodRemuxTasksRequest extends  AbstractModel {
    constructor(){
        super();
 ...
 * @class
 */
class DescribeStreamPackageVodRemuxTasksResponse extends  AbstractModel {
    constructor(){
        super();

        /**
         * VOD remux task lists.
         * @type {Array.<VodRemuxTaskInfo> || null}
         */
        this.Infos = null;
 ...
 * @class
 */
class DescribeStreamPackageSSAIUsageResponse extends  AbstractModel {
    constructor(){
        super();

        /**
         * SSAI usage information.
         * @type {SSAIUsageInfo || null}
         */
        this.Info = null;
 ...
 * @class
 */
class DeleteStreamPackageVodRemuxTaskResponse extends  AbstractModel {
    constructor(){
        super();
...
class SSAIUsageInfo extends  AbstractModel {
    constructor(){
         ...
         * @type {number || null}
         */
        this.AdRequestSuccess = null;

        /**
         * Number of failed ad requests.
         * @type {number || null}
         */
        this.AdRequestFail = null;
         ...
         * @type {number || null}
         */
        this.MidFillRate = null;

        /**
         * Advertising tag time.
         * @type {number || null}
         */
        this.AdMarkerTime = null;

        /**
         * Personalization replacement time.
         * @type {number || null}
         */
        this.ReplacedTime = null;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    deserialize(params) {
        ...
        this.AdRequestSuccess = 'AdRequestSuccess' in params ? params.AdRequestSuccess : null;
        this.AdRequestFail = 'AdRequestFail' in params ? params.AdRequestFail : null;
        this.Impression = 'Impression' in params ? params.Impression : null;
        this.MidFillRate = 'MidFillRate' in params ? params.MidFillRate : null;
        this.AdMarkerTime = 'AdMarkerTime' in params ? params.AdMarkerTime : null;
        this.ReplacedTime = 'ReplacedTime' in params ? params.ReplacedTime : null;
 ...
 * @class
 */
class CreateStreamPackageVodRemuxTaskResponse extends  AbstractModel {
    constructor(){
        super();
 ...
 * @class
 */
class StartStreamPackageVodRemuxTaskRequest extends  AbstractModel {
    constructor(){
        super();
...
class UsageDetail extends  AbstractModel {
    ...
    deserialize(params) {
        ...
        this.FirstQuarter = 'FirstQuarter' in params ? params.FirstQuarter : null;
        this.Midpoint = 'Midpoint' in params ? params.Midpoint : null;
        this.ThirdQuarter = 'ThirdQuarter' in params ? params.ThirdQuarter : null;
        this.Complete = 'Complete' in params ? params.Complete : null;
        this.AdMarkerTime = 'AdMarkerTime' in params ? params.AdMarkerTime : null;
        this.ReplacedTime = 'ReplacedTime' in params ? params.ReplacedTime : null;
        this.MidFillRate = 'MidFillRate' in params ? params.MidFillRate : null;
        this.PreReqNum = 'PreReqNum' in params ? params.PreReqNum : null;
...
module.exports = {
    DRMInfo: DRMInfo,
    DescribeStreamPackageVodRemuxTaskRequest: DescribeStreamPackageVodRemuxTaskRequest,
    SourcePackageConf: SourcePackageConf,
    CreateStreamPackageSSAIChannelRequest: CreateStreamPackageSSAIChannelRequest,
    StartStreamPackageVodRemuxTaskResponse: StartStreamPackageVodRemuxTaskResponse,
    ...
    DescribeStreamPackageVodRemuxTaskResponse: DescribeStreamPackageVodRemuxTaskResponse,
    ...
    DeleteStreamPackageVodRemuxTasksRequest: DeleteStreamPackageVodRemuxTasksRequest,
    ...
    DeleteStreamPackageVodRemuxTasksResponse: DeleteStreamPackageVodRemuxTasksResponse,
    ...
    DeleteStreamPackageVodRemuxTaskRequest: DeleteStreamPackageVodRemuxTaskRequest,
    ...
    DescribeStreamPackageVodRemuxTasksRequest: DescribeStreamPackageVodRemuxTasksRequest,
    ...
    DescribeStreamPackageVodRemuxTasksResponse: DescribeStreamPackageVodRemuxTasksResponse,
    DescribeStreamPackageSSAIUsageResponse: DescribeStreamPackageSSAIUsageResponse,
    ...
    DeleteStreamPackageVodRemuxTaskResponse: DeleteStreamPackageVodRemuxTaskResponse,
    ...
    CreateStreamPackageVodRemuxTaskResponse: CreateStreamPackageVodRemuxTaskResponse,
    ...
    StartStreamPackageVodRemuxTaskRequest: StartStreamPackageVodRemuxTaskRequest,
