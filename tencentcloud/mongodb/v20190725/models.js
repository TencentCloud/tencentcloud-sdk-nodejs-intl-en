...
**Note**: When MirrorTplId is not empty, MongoVersion and ClusterType will follow the template version and instance type of MirrorTpl.
    ...
    deserialize(params) {
        ...
        this.MongoVersion = 'MongoVersion' in params ? params.MongoVersion : null;
        this.ClusterType = 'ClusterType' in params ? params.ClusterType : null;
        this.TplDesc = 'TplDesc' in params ? params.TplDesc : null;

        if (params.Params) {
            this.Params = new Array();
            for (let z in params.Params) {
                let obj = new ParamType();
                obj.deserialize(params.Params[z]);
                this.Params.push(obj);
            }
        }
        this.MirrorTplId = 'MirrorTplId' in params ? params.MirrorTplId : null;
...
/**
 * EnablePasswordRotation response structure.
 * @class
 */
class EnablePasswordRotationResponse extends  AbstractModel {
    constructor(){
        super();
 ...
 * @class
 */
class ParamType extends  AbstractModel {
    constructor(){
        super();
...
/**
 * DeleteDBBackups request structure.
 * @class
 */
class DeleteDBBackupsRequest extends  AbstractModel {
    constructor(){
        super();
...
/**
 * DeleteDBBackups response structure.
 * @class
 */
class DeleteDBBackupsResponse extends  AbstractModel {
    constructor(){
        super();
...
-STANDALONE: Single-node instance.
    ...
    deserialize(params) {
        ...
        if (params.InstanceEnumParams) {
            this.InstanceEnumParams = new Array();
            for (let z in params.InstanceEnumParams) {
                let obj = new InstanceEnumParam();
                obj.deserialize(params.InstanceEnumParams[z]);
                this.InstanceEnumParams.push(obj);
            }
        }

        if (params.InstanceIntegerParams) {
            this.InstanceIntegerParams = new Array();
            for (let z in params.InstanceIntegerParams) {
                let obj = new InstanceIntegerParam();
                obj.deserialize(params.InstanceIntegerParams[z]);
                this.InstanceIntegerParams.push(obj);
            }
        }

        if (params.InstanceTextParams) {
            this.InstanceTextParams = new Array();
            for (let z in params.InstanceTextParams) {
                let obj = new InstanceTextParam();
                obj.deserialize(params.InstanceTextParams[z]);
                this.InstanceTextParams.push(obj);
            }
        }

        if (params.InstanceMultiParams) {
            this.InstanceMultiParams = new Array();
            for (let z in params.InstanceMultiParams) {
                let obj = new InstanceMultiParam();
                obj.deserialize(params.InstanceMultiParams[z]);
                this.InstanceMultiParams.push(obj);
            }
        }
        this.TotalCount = 'TotalCount' in params ? params.TotalCount : null;
        this.MongoVersion = 'MongoVersion' in params ? params.MongoVersion : null;
...
/**
 * DescribePasswordRotation request structure.
 * @class
 */
class DescribePasswordRotationRequest extends  AbstractModel {
    constructor(){
        super();
...
/**
 * DescribeDBInstanceParamTpl response structure.
 * @class
 */
class DescribeDBInstanceParamTplResponse extends  AbstractModel {
    constructor(){
        super();

        /**
         * Parameter template list info.
         * @type {Array.<ParamTpl> || null}
         */
        this.ParamTpls = null;
    ...
    deserialize(params) {
        ...
        if (params.ParamTpls) {
            this.ParamTpls = new Array();
            for (let z in params.ParamTpls) {
                let obj = new ParamTpl();
                obj.deserialize(params.ParamTpls[z]);
                this.ParamTpls.push(obj);
            }
        }
        this.TotalCount = 'TotalCount' in params ? params.TotalCount : null;
        this.RequestId = 'RequestId' in params ? params.RequestId : null;
...
module.exports = {
    ...
    ModifyBackupExpireTimeResponse: ModifyBackupExpireTimeResponse,
    ...
    DeleteDBBackupsRequest: DeleteDBBackupsRequest,
    ...
    DeleteDBBackupsResponse: DeleteDBBackupsResponse,
    ...
    DescribePasswordRotationRequest: DescribePasswordRotationRequest,
