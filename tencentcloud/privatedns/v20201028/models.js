 ...
 * @class
 */
class QueryAsyncBindVpcStatusResponse extends  AbstractModel {
    constructor(){
        super();
...
/**
 * DeleteSpecifyPrivateZoneVpc request structure.
 * @class
 */
class DeleteSpecifyPrivateZoneVpcRequest extends  AbstractModel {
    constructor(){
        super();
...
/**
 * QueryAsyncBindVpcStatus request structure.
 * @class
 */
