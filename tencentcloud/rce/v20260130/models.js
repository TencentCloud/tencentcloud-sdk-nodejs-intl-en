...
/**
 * AssessRisk response structure.
 * @class
 */
class AssessRiskResponse extends  AbstractModel {
    constructor(){
        super();

        /**
         * <p>The results of AssessRisk</p>
         * @type {AssessRiskRsp || null}
         */
        this.Data = null;
...
module.exports = {
    ...
    Amount: Amount,
    SMSEvent: SMSEvent,
    AssessRiskResponse: AssessRiskResponse,
